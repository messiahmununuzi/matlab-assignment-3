...
leaf1 = imread("G:\leaf project\leaf images\WhatsApp Image 2026-09-13 at 06.47.48(1).jpeg");
figure;
imshow(leaf1)
ds3 = im2gray(leaf1);
figure;
...
leaf2 = imread("G:\leaf project\leaf images\WhatsApp Image 2026-09-13 at 06.47.48.jpeg");
figure;
imshow(leaf2)
ds2 = im2gray(leaf2);
figure;
...
leaf3 = imread("G:\leaf project\leaf images\WhatsApp Image 2026-09-13 at 06.47.49(1).jpeg");
figure;
imshow(leaf3)
ds3 = im2gray(leaf3);
figure;
...
leaf4 = imread("G:\leaf project\leaf images\WhatsApp Image 2026-09-13 at 06.47.49.jpeg");
figure;
imshow(leaf4);
ds4 = im2gray(leaf4);
figure;
...
leaf5 = imread("G:\leaf project\leaf images\WhatsApp Image 2026-09-13 at 06.47.50(1).jpeg");
figure;
imshow(leaf5);
ds5 = im2gray(leaf5);
figure;
...
% 2. Read image
leaf6 = imread("G:\leaf project\leaf images\WhatsApp Image 2026-09-13 at 06.47.50.jpeg");
figure;
imshow(leaf6);
ds6 = im2gray(leaf6);
figure;
...
leaf7 = imread("G:\leaf project\leaf images\WhatsApp Image 2026-09-13 at 06.47.51.jpeg");
figure;
imshow(leaf7);
ds7 = im2gray(leaf7);
figure;
